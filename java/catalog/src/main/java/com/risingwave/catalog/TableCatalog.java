...
public class TableCatalog extends EntityBase<TableCatalog.TableId, TableCatalog.TableName>
  ...
  private final ImmutableIntList primaryKeyColumnIndices;
  ...
  public ImmutableIntList getPrimaryKeyColumnIndices() {
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        ...
        .add("columns", columns)
        .add("primaryKeyColumnIndices", primaryKeyColumnIndices)
