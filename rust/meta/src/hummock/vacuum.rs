...
/// - 2 Corresponding SST files are created in object store.
...
/// - 4.2 Or if step 3 didn't happen after some time, the SST is deleted as orphan data
///   asynchronously.
    ...
    S: MetaStore,
{
    ...
    /// - And it is not the greatest version at the same time. We never vacuum the greatest
    ///   version.
